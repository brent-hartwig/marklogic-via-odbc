...
(:
 ...
 The source model was supplier-1.0.0
 ...
 Generated at timestamp: 2020-11-23T21:40:37.476628Z
 :)

module namespace supplier
    = 'http://example.org/supplier-1.0.0';
...
(:~
 ...
 :)
declare function supplier:extract-instance-supplier(
    $source as item()?
) as map:map
{
...
(:~
 ...
 :)
declare function supplier:instance-to-canonical(
...
) as node()
{
        ...
        then xdmp:to-json( supplier:canonicalize($entity-instance) )/node()
        else supplier:instance-to-canonical-xml($entity-instance)
};
...
(:~
 ...
 :)
declare private function supplier:canonicalize(
    $entity-instance as map:map
) as map:map
{
    json:object()
                    ...
                    return
                        ...
                        case json:object
                            return
                                ...
                                else map:put($m, $key, supplier:canonicalize($instance-property))
                        ...
                        case json:array
                            return
                                ...
                                return
                                    ...
                                    then json:set-item-at($instance-property, $i, supplier:canonicalize($val))
                                    else (),
...
(:~
 ...
 : @return An XML element that encodes the instance.
 :)
declare private function supplier:instance-to-canonical-xml(
    $entity-instance as map:map
) as element()
{
                ...
                return
                    ...
                    case json:object+
                        return
                            ...
                            return element { $ns-key } { supplier:instance-to-canonical-xml($prop) }
                    (: An array can also treated as multiple elements :)
                    case json:array
                        return
                            ...
                            return
                                ...
                                then element { $ns-key } {
                                    ...
                                    supplier:instance-to-canonical-xml($val)
                                }
                                else element { $ns-key } {
                                    attribute datatype { 'array' },
                                    $val }
...
(:
 ...
 :)
declare function supplier:instance-to-envelope(
    $entity-instance as map:map,
    $envelope-format as xs:string
) as document-node()
{
    let $canonical := supplier:instance-to-canonical($entity-instance, $envelope-format)
...
{
    supplier:instance-to-envelope($entity-instance, "xml")
};
